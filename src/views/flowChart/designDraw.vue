<template>
  <div id="designDraw">
    ...
    <div class="property-panel-container" :style="{ width: panelWidth }">
      ...
      />
      <div v-if="collapsed" class="collapse-property-panel-right" @click="handleCollapsePanel">
        <i class="el-icon-d-arrow-right" />
      </div>
      <div v-else class="collapse-property-panel-left" @click="handleCollapsePanel">
...
export default {
  ...
  computed: {
    panelWidth: function() {
      return this.collapsed ? '430px' : '30px'
    }
  },
  created() {
