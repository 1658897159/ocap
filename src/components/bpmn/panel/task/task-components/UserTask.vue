<template>
  <div>
    <el-form-item label="审核者">
      <el-select v-model="userTaskForm.assignee" multiple :collapse-tags="userTaskForm.assignee && userTaskForm.assignee.length > 4" @change="updateElementTask('assignee')">
